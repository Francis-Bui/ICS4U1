...
public class Form1
{
    ...
    // Physics
    private int ballxVel = 30;
    private int ballyVel = 30;
    private int padyVel = 20;
    private int velInc = 3;
    private int pdlInc = 10;
    private int lazerVel = 70;
    private int powerVel = 20;
    ...
    private int shieldHpL = 0;
    private int shieldHpR = 0;
    private int padLHeight = 150;
    private int padRHeight = 150;

    private Random rnd = new Random();

    // Rectangles'
    private Rectangle rBall;
    private Rectangle rPadL;
    private Rectangle rPadR;
    private Rectangle rTitle;
    private Rectangle rWinner;
    private Rectangle rStart;
    private Rectangle rQuit;
    private Rectangle rScoreL;
    private Rectangle rScoreR;
    private Rectangle rExplosion;
    private Rectangle rLaserL;
    private Rectangle rLaserR;
    private Rectangle rBackHPL;
    private Rectangle rBackHPR;
    private Rectangle rHPL;
    private Rectangle rHPR;
    private Rectangle rBackShotL;
    private Rectangle rShotL;
    private Rectangle rBackShotR;
    private Rectangle rShotR;

    private void pbCanvas_Paint(System.Object sender, System.Windows.Forms.PaintEventArgs e)
    {
        if (start == false)
        {
    ...
    private void Form1_Load(System.Object sender, System.EventArgs e)
    {
        ...
        // Ships'
        rPadL = new Rectangle(60, pbCanvas.Height / (double)2 - 150, 60, 150);
    ...
    private void CentreBall()
    {
        ...
        rBall.Location = new Point(pbCanvas.Width / (double)2, pbCanvas.Height / (double)2);
    ...
    private void pbCanvas_MouseDown(System.Object sender, System.Windows.Forms.MouseEventArgs e)
    {
